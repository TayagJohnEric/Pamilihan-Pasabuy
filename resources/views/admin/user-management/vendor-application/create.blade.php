...
<div class="max-w-4xl mx-auto py-8 px-4">
    <div class="bg-white rounded-xl shadow-lg overflow-hidden">
        ...
        <div class="bg-gradient-to-r from-emerald-600 to-emerald-700 px-8 py-6">
            <h2 class="text-3xl font-bold text-white">Create Vendor Account</h2>
            <p class="text-emerald-100 mt-1">Set up credentials for the new vendor account</p>
        </div>
        ...
        <!-- Form Section -->
        <form method="POST" action="{{ route('admin.vendor_applications.storeVendor', $application->id) }}" class="px-8 py-8">
            @csrf
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input 
                            ...
                            id="phone_number"
                            name="phone_number" 
                            value="{{ old('phone_number', $application->applicant_phone_number) }}" 
