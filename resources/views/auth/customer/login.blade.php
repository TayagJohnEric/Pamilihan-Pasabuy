...
<body class="bg-white flex items-center justify-center min-h-screen">
    ...
    <div class="bg-white w-full max-w-md mx-auto container-responsive py-8 px-6 sm:px-8 md:p-8">
        ...
        <div class="flex items-center justify-center gap-3 mb-4 sm:mb-6 welcome-animation">
            ...
            <!-- Text -->
            <div class="text-left">
                <span class="text-xl sm:text-2xl font-bold text-gray-900 block">PasaBuy</span>
        ...
        <div class="text-center mb-6 sm:mb-8 welcome-animation">
            ...
            <p class="text-gray-600 font-medium text-sm sm:text-md">Ready to continue your shopping journey?</p>
        </div>
        ...
        <form id="login-form" class="form-animation">
            ...
            <div class="mb-6 sm:mb-8">
                <label class="flex items-center cursor-pointer">
                    <input type="checkbox" name="remember" class="remember-checkbox w-4 h-4 sm:w-4 sm:h-4 rounded border-gray-300 focus:ring-emerald-500 focus:ring-2">
                    <span class="ml-2 sm:ml-2 text-sm font-small text-gray-500">Remember me</span>
                </label>
            </div>
        ...
        <div class="text-center form-animation">
            <p class="text-gray-600 font-semibold text-sm">
                ...
                <a href="{{ route('customer.register') }}" class="text-emerald-600 hover:text-emerald-700 font-semibold transition-colors duration-200 hover:underline">
                    Create one now
                </a>
            </p>
        </div>
            ...
            $('#login-form').on('submit', function (e) {
                ...
                $.ajax({
                    ...
                    error: function (xhr) {
                        ...
                        const errorMsg = res?.errors?.email ? res.errors.email[0] : 'Login failed. Please check your credentials.';
